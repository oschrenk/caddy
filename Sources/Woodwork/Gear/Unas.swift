...
public struct Unas: Shape3D {
    public let width = 135.0
    public let depth = 129.0
    public let height = 223.7
    public let cornerRadius = 15.0

    // Stadium-shaped cutout on the front face
    public let pillWidth = 20.0
    public let pillHeight = 37.3
    public let pillCutDepth = 2.0
