...
public struct Monitor: Shape3D {
    public let screenWidth: Double     // along x
    public let screenHeight: Double    // along z
    public let screenThickness: Double // along y
    public let neckWidth: Double       // along x
    public let neckDepth: Double       // along y
    public let neckHeight: Double      // along z, from top of base to top of neck
    public let baseWidth: Double       // along x
    public let baseDepth: Double       // along y
    public let baseHeight: Double      // along z
    public let screenBottomZ: Double   // bottom edge of screen above the base top
