...
public struct StandingDesk: Shape3D {
    // Top
    public let topWidth: Double // along x (1397 = 55")
    public let topDepth: Double // along y (711  = 28")
    public let topThickness: Double

    // Frame
    public let deskHeight: Double // top surface of the desktop above the floor
    public let footLength: Double // along y (front-to-back)
    public let footWidth: Double // along x (narrow dimension of the foot)
    public let footHeight: Double // along z
    public let columnWidth: Double // along x
    public let columnDepth: Double // along y
    public let columnInsetFromEnd: Double // x-distance from each end of the top to column centerline
    public let crossbarLengthCutout: Double // gap left at each end of the crossbar (column thickness)
    public let crossbarHeight: Double // cross-section along z
    public let crossbarDepth: Double // cross-section along y
    public let crossbarZ: Double // z of the crossbar's vertical centerline
